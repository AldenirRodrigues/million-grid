          ...
          <div className="p-6 space-y-6 flex-1 overflow-y-auto custom-scrollbar">
             ...
             <div className="space-y-2">
               ...
               <input
                 ...
                 className={`w-full px-4 py-3 border rounded-xl focus:ring-4 outline-none transition-all text-sm ${
                   error ? 'border-red-200 focus:ring-red-50' : 'border-gray-100 focus:ring-blue-50'
                 }`}
               />
          ...
          <div className="px-8 py-5 border-t border-gray-50 bg-gray-50/50 flex items-center justify-between">
            ...
            <div className="flex gap-3">
              ...
              <button 
                ...
                className={`px-8 py-2.5 text-xs font-black rounded-xl transition-all flex items-center gap-2 shadow-lg shadow-blue-200/50 ${
                  !imageUrl || !previewOk || isValidating
